...
debug: keynav.o ConfigureKeys.o
	$(CC) keynav.o ConfigureKeys.o -o keynav $(CFLAGS) $(LDFLAGS) -lxdo

keynav:CFLAGS+=-O2
keynav: keynav.o ConfigureKeys.o
	$(CC) keynav.o ConfigureKeys.o -o keynav $(CFLAGS) $(LDFLAGS) -lxdo
	strip keynav
